...
#define MAGISTER_GNUPLOT_AGGREGATOR_H
 ...
 **/
class MagisterGnuplotAggregator : public DataCollectionObject
{
public:
  ...
  /**
   * Constructs a gnuplot file aggregator.
   *
   * The instance will create a space-separated gnuplot data file named
   * #m_outputFileNameWithoutExtension + ".dat", a gnuplot control file named
   * #m_outputFileNameWithoutExtension + ".plt", and a shell script to
   * generate the gnuplot named #m_outputFileNameWithoutExtension + ".sh".
   * All of these files are created in #m_outputPath.
   */
  MagisterGnuplotAggregator ();

  virtual ~MagisterGnuplotAggregator ();
...
#endif // MAGISTER_GNUPLOT_AGGREGATOR_H
